...
function revealHandler(element, index) {
  if (element.classList.contains('revealed')) {
    ...
    imageContainerWidth = imageContainer.querySelector('img').offsetWidth, ueberbleib = windowWidth - imageContainerWidth, ueberbleibProImage = ueberbleib / amountOfImages, rotation = -5 + 25 * index * 0.1 + 'deg';
